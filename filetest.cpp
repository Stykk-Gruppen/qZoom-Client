...
int filetest::main()
{
    ...
    src_filename = "raw.mp4";
    video_dst_filename = "demuxedVideo.mp4";
    audio_dst_filename = "demuxedAudio.mp3";
   ...
   /* AVInputFormat* audioInputFormat = av_find_input_format("alsa");
    ...
    //Open AudioInput
    if(avformat_open_input(&fmt_ctx, "default", audioInputFormat, NULL) < 0)
    {
        fprintf(stderr, "Could not open audio input file '%s'", "default");
        return -1;
    }*/
...
int filetest::re()
{
    ...
    in_filename  = "radmila.mp4";
    out_filename = "playable.mp4";
    ...
    if (ret < 0 && ret != AVERROR_EOF) {
        fprintf(stderr, "Error occurrent");
        return 1;
    }
