...
class VideoHandler : public QObject
{
    Q_OBJECT
public:
    VideoHandler(QString cDeviceName, std::mutex* _writeLock,int64_t time, int _numberOfFrames, ImageHandler* imageHandler, SocketHandler* _socketHandler, QObject* parent = 0);
    int init();
    void grabFrames();
