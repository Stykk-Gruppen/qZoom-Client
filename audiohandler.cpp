                           ...
                           AVCodecContext **input_codec_context)
{
    ...
    if ((error = avformat_open_input(input_format_context, "default", audioInputFormat,
                                     NULL)) < 0) {
                                  ...
                                  int frame_size)
{
     ...
     */
    if (!(*converted_input_samples = static_cast<uint8_t **>(calloc(output_codec_context->channels,sizeof(**converted_input_samples)))))
    {
...
int AudioHandler::main()
{
    ...
    if (open_input_file(&input_format_context,
                        &input_codec_context))
        goto cleanup;
    /* Open the output file for writing. */
    if (open_output_file("test.mp4", input_codec_context,
